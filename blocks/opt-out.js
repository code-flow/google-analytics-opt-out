...
export default registerBlockType(
		'gaoop/opt-out-block',
		{
			...
			keywords  : [
				'gaoop',
				__( 'Analytics Opt In/Out', 'google-analytics-opt-out' )
			],
			attributes: {
				content: {
					source  : 'text',
					selector: 'a',
					default : 'opt-out' === window.gaoop_mode
							? __( 'Click here to opt out', 'google-analytics-opt-out' )
							: __( 'Click here to opt in', 'google-analytics-opt-out' )
				}
			},
			...
			edit: props => {
				...
				const default_text = 'opt-out' === window.gaoop_mode
						? __( 'Click here to opt out', 'google-analytics-opt-out' )
						: __( 'Click here to opt in', 'google-analytics-opt-out' );
